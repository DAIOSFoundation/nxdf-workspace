...
import { SwapData, products } from '../../../utils/dummy';
...
const SwapDetailScreen = () => {
  ...
  const [fCoin, setFCoin] = useState('SOL');
    ...
    <SafeAreaView bgNavyTheme>
      ...
      <TopView>
        <FromView>
          ...
          <FromText>{`Balance: ${fInput} ${fCoin}`}</FromText>
        </FromView>
        <SwapBox>
          <SwapCoin>
      ...
      <SwapView>
        ...
        <SwapBox>
          ...
          <SwapPrice>
            ...
            <SwapText>{`${sCoin}`}</SwapText>
          </SwapPrice>
        </SwapBox>
        <ToText>{`Balance: ${fInput} ${sCoin}`}</ToText>
      </SwapView>
      {/* 상세 정보 창 */}
